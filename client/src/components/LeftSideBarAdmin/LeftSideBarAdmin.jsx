...
const LeftSideBarAdmin = () => {
  ...
  return (
    <div
      ...
      } border-r-4 border-customPrimary h-screen rounded-md transition-all duration-300 ease-in-out`}
    >
      ...
      <div className="grid overflow-hidden ">
        ...
        <h1 className="text-customPrimary">Menu</h1>
            ...
            <div
              onClick={logOut}
              className=" px-5 Menu w-full cursor-pointer h-[75px] flex flex-col border-l-8  border-l-customPrimary rounded"
            >
