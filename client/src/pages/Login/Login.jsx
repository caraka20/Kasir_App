      ...
      return (
        <div className='flex justify-center items-center bg-slate-400 h-screen'>
          ...
          <div className="mb-10">
            ...
            <Link to={`/forgetpassword`}><p className="text-black hover:text-blue-500 text-sm px-5 py-2.5 text-end">Forgot your Password?</p></Link>
            ...
            {/* {visiblePassword ? <AiOutlineEye className='w-5 h-5'/> : <AiOutlineEyeInvisible className='w-5 h-5'/>} */}
