      ...
      return (
        <div className='flex justify-center items-center bg-slate-400 h-screen'>
          ...
          <div className="mb-10">
            ...
            <Link to={`/forgetpassword`}><p className="text-black hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Forget your password?</p></Link> 
          </form>
          </div>
        </div>
      )
